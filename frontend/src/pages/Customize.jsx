...
function Customize() {
  ...
  return (
    ...
    <div className='w-full h-[100vh] bg-gradient-to-b from-[#030353]
     ...
     flex-col p-[20px] '>
      <h1 className='text-white mb-[30px] text-[30px] text-center'>Select your <span 
      className='text-blue-200'>Assistant Image</span></h1>
   ...
   <div className={`w-[70px] h-[140px] lg:w-[150px] lg:h-[250px] bg-[#020220] border-2
     ...
     hover:border-4 hover:border-white flex items-center justify-center ${SelectedImage=="input"?
      "border-4 border-white shadow-2xl shadow-blue-950 ":""}`} onClick={() =>{
    ...
    onChange={handleImage}/>
      ...
      font-semibold cursor-pointer bg-white rounded-full text-[19px]' onClick={()=>navigate("/customize2")}>Next</button>}
    </div>
  )
}
